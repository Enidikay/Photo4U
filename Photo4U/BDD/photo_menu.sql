...
CREATE TABLE `menu` (
  ...
  `Habilitation` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`idMenu`),
...
INSERT INTO `menu` VALUES (1,'Acheter','acheter.php','client'),(2,'Vendre','vendre.php','Photographe'),(3,'Les plus populaires','trends.php','client, visiteur,Photographe'),(4,'Les nouveautés','new.php','client, visiteur, Photographe'),(5,'Tarifs','tarifs.php','client');
